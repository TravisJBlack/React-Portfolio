            ...
            <section className="bg-white dark:bg-black">
                <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                    ...
                    <div className='flex flex-wrap justify-center '>
                        <a href="https://www.linkedin.com/in/travis-black-b262681ab/" target="_blank">
                            <img className="m-2 w-12 h-12 hover:scale-150 transition duration-500 shadow-lg shadow-red-500 " src={linkedinLogo} alt="image of linkedin logo" />
                        </a>
                        <a href='mailto:travisjblack93@gmail.com' target="_blank">
                            <img className="m-2 w-12 h-12 hover:scale-150 transition duration-500 shadow-lg shadow-red-500 " src={emailLogo} alt="image of linkedin logo" />
                        </a>
                        <a href="https://github.com/TravisJBlack" target="_blank">
                            <img className="m-2 w-12 h-12 shadow-lg hover:scale-150 transition duration-500 shadow-red-500" src={githubLogo} alt="image of javascript logo" />
                        </a>
                    </div>

        ...
        <>
            <div className="min-h-screen bg-black">
                ...
                <div className="flex flex-wrap justify-center m-3 md:pb-3">
                    <img className='mx-1 w-12 h-12 shadow-lg shadow-red-500' src="../../public/html.svg" alt="image of html logo" />
                    <img className="mx-1 w-12 h-12 shadow-lg shadow-red-500" src="../../public/css.svg" alt="image of css logo" />
                    <img className="mx-1 w-12 h-12 shadow-lg shadow-red-500" src="../../public/javascript.svg" alt="image of javascript logo" />
                    <img className="mx-1 w-12 h-12 shadow-lg shadow-red-500" src="../../public/mongodb.svg" alt="image of mongodb logo" />
                    <img className="mx-1 w-12 h-12 shadow-lg shadow-red-500" src="../../public/nodejs.svg" alt="image of nodejs logo" />
                    <img className="mx-1 w-12 h-12 shadow-lg shadow-red-500" src="../../public/postgresql.svg" alt="image of postgresql logo" />
                    <img className="mx-1 w-12 h-12 shadow-lg shadow-red-500" src="../../public/webpack.svg" alt="image of webpack logo" />
                </div>
